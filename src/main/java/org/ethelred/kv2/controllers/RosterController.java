...
public class RosterController {
    ...
    public RosterController(SimpleRosterRepository rosterRepository, UserService userService, PatchHelper patchHelper) {
    ...
    public SimpleRosterRepository rosterRepository() {
